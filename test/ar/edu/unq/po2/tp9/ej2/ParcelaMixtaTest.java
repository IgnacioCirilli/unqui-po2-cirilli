...
class ParcelaMixtaTest {
	...
	void verificacionCuandoSeRemuveUnaParcelaAParcelaMixtaSusParcelasDisminuyen() {
		...
		//exercise
		this.parcelaMixta1.removerParcela(parcelaPura1);
	...
	void verificacionCuandoUnaParcelaMixtaSeCreaNoTieneValorAnual() {
		assertEquals(0, this.parcelaMixta1.obtenerGananciasAnualesTotales());
	}
	
	@Test
	void verificacionValorAnualTotalDeUnaParcelaMixtaQueSoloTieneParcelasPuras() {
		//mockeando
		when(this.parcelaPura1.obtenerGananciasAnualesTotales()).thenReturn(300d);
		when(this.parcelaPura2.obtenerGananciasAnualesTotales()).thenReturn(500d);
		when(this.parcelaPura3.obtenerGananciasAnualesTotales()).thenReturn(500d);
		when(this.parcelaPura4.obtenerGananciasAnualesTotales()).thenReturn(300d);
		...
		assertEquals(gananciaAnualTotalEsperada, this.parcelaMixta1.obtenerGananciasAnualesTotales());
	}
	...
	void verificacionValorAnualTotalDeUnaParcelaMixtaQueTieneParcelasPurasYMixtas() {
		...
		when(this.parcelaPura1.obtenerGananciasAnualesTotales()).thenReturn(300d);
		when(this.parcelaPura2.obtenerGananciasAnualesTotales()).thenReturn(500d);
		when(this.parcelaPura3.obtenerGananciasAnualesTotales()).thenReturn(300d);
